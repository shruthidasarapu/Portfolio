...
function AboutPage() {
    return(
        <div className="AboutPage">
          ...
          <Education  title= {'Web Development'} text={'Hack Your Future 2021, Copenhagen'} />
          <Education  title= {'Coding'} text={'Redi school 2020, Copenhagen'} />
          <Education  title= {'Danish Language PD3'} text={'Hellerup Sprøg Skole 2019, Lyngby'} />
          <Education  title= {'Bachelors in Engineering'} text={'JNT University 2015, India'} />
            </div>
        </div>
    )
}
